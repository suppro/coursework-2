...
namespace ARU.StatusDataTableAdapters {
    ...
    public partial class StatusTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Status] WHERE (([status_name] = @Original_status_name) AND ([id] = @" +
                "Original_id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Status] ([status_name]) VALUES (@status_name);\r\nSELECT status_name, " +
                "id FROM Status WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Status] SET [status_name] = @status_name WHERE (([status_name] = @Origina" +
                "l_status_name) AND ([id] = @Original_id));\r\nSELECT status_name, id FROM Status W" +
                "HERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT status_name, id FROM Status";
        ...
        public virtual int Fill(StatusData.StatusDataTable dataTable) {
        ...
        public virtual StatusData.StatusDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StatusData.StatusDataTable dataTable = new StatusData.StatusDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StatusData.StatusDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StatusData dataSet) {
        ...
        public virtual int Delete(string Original_status_name, int Original_id) {
            if ((Original_status_name == null)) {
                throw new global::System.ArgumentNullException("Original_status_name");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((string)(Original_status_name));
            }
        ...
        public virtual int Update(string status_name, string Original_status_name, int Original_id, int id) {
            if ((status_name == null)) {
                throw new global::System.ArgumentNullException("status_name");
            }
            else {
            ...
            if ((Original_status_name == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(Original_status_name));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string status_name, string Original_status_name, int Original_id) {
            return this.Update(status_name, Original_status_name, Original_id, Original_id);
        }
    }
